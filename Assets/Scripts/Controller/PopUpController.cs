...
public class PopUpController : MonoBehaviour {
    ...
    {
        grade.setData();
        StartCoroutine(ieMoveDown(grade.gameObject, showY));
    }
    public void HideGrade()
    {
        StartCoroutine(ieMoveUp(grade.gameObject, hideY));
    }
    ...
    public void ShowQuestionSapXepL1()
    {
        questionSXL1.setPlay();
        StartCoroutine(ieMoveDown(questionSXL1.gameObject, showY));
    }
    public void HideQuestionSapXepL1()
    {
        StartCoroutine(ieMoveUp(questionSXL1.gameObject, hideY));
    }
    ...
    public void ShowQuestionBangNhauL1()
    {
        questionBNL1.setPlay();
        StartCoroutine(ieMoveDown(questionBNL1.gameObject, showY));
    }
    public void HideQuestionBangNhauL1()
    {
        StartCoroutine(ieMoveUp(questionBNL1.gameObject, hideY));
    }
